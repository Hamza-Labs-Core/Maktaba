    ...
    <div className="mkt-shell">
      ...
      <div className="mkt-shell__body">
        <nav className="mkt-shell__nav" aria-label="Primary">
          <NavLink to="/library" className="mkt-nav-link">{t('nav.library')}</NavLink>
          <NavLink to="/search" className="mkt-nav-link">{t('nav.search')}</NavLink>
          <NavLink to="/queue" className="mkt-nav-link">{t('nav.queue')}</NavLink>
          <NavLink to="/settings" className="mkt-nav-link">{t('nav.settings')}</NavLink>
        </nav>
