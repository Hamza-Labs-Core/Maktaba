    ...
    <section className="mkt-page mkt-guide">
      ...
      {channels.length === 0 ? (
        <EmptyState
          ...
          action={
            <Button onClick={() => nav("/admin/channels")}>{t("guide.empty.cta")}</Button>
          }
        />
      ) : compact ? (
            ...
            return (
              <div className="mkt-guide__row" key={channel.id}>
                ...
                <div className="mkt-guide__track" style={{ width: gridWidth }}>
                  {cells.length === 0 && (
                    <div className="mkt-guide__cell mkt-guide__cell--empty" style={{ width: gridWidth }}>
                      {t("guide.noContent")}
                    </div>
                  )}
                  {cells.map((p) => {
